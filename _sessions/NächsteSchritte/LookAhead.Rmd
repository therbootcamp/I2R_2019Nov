...
1. `ggplot2` für Graphiken.
2. `dplyr` für Datenverarbeitung.
3. `tidyr` für Datenaufverarbeitung.
...
1. `markdown` für dynamische PDF Dokumente.
...
[Stackoverflow](https://stackoverflow.com/questions/tagged/r) ist eine Seite für R Probleeme und Lösungen. Versucht selbst mal ein Problem zu posten. Oft bekommt ihr erstaunlich schnell Antwort.
